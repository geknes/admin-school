        ...
        <div class="row setup-content" id="step-1">
            <div class="col-xs-12">
              <div class="well text-center">
                ...
                <f:input type="file" class="filestyle" path="sliderDetalleBean.file" id="file"
...
<!--               <div class="row">
    ...
    <%-- 	<button id="btnConfirmarGeneric" type="button" class="btn btn-outline-primary" onclick="crudSlider()"><i class="fa fa-upload"></i> Subir</button>--%>
