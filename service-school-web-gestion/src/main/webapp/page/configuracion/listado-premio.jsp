            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Listado Premios </a>
                  </li>
                </ol>
              </div>
            </div>
                                     ...
                                     <f:form method="post" action="buscar">
                                      <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre Premio</label>
                                                <f:input type="text" path="nombre" class="form-control"/>
                                            </div>
                                            <div class="form-group col-md-3 mb-2">
                                              <label for="region">Regi&oacute;n</label>
                                              <f:select id="lblregion"  path="region.codigoRegistro" class="form-control">
                                            ...
                                            <table class="table table-striped table-hover table-bordered zero-configuration">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="60"><center>Acci&oacute;n</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
