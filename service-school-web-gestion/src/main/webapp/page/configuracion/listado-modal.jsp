            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Listado De Mondos </a>
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de Modal </h4>
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <c:forEach var="modalBean" items="${lstModalBean}">
                                                    <tr>
                                                        <td>${modalBean.nombre}</td>

                                                        <td><center>
                                                      <c:choose>
                                                      <c:when test="${not empty modalBean.imagenNombre}">
                                                        <img class="media-object" src="${pageContext.request.contextPath}/modal/${modalBean.imagenNombre}" alt="${modalBean.imagenNombre}" style="width: 75px;height: 75px;" />
                                                      </c:when>
                                                      <c:otherwise>
                                                        ...
                                                        <td>${modalBean.situacion.nombreCorto} </td>
