<%@ page contentType="text/html; charset=UTF-8" %>
    ...
    <title>Listado de Tabla Maestra</title>
              ...
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                 <li class="breadcrumb-item"><a href="#">Otros</a>
                  ...
                  <li class="breadcrumb-item active"><a href="#"> Listado Tabla Maestra</a>
                  </li>
                </ol>
              </div>
            </div>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                          <div class="form-group col-md-4 mb-2">
                                              ...
                                              <f:select id="lblcodigo"  path="codigoTabla" class="form-control">
                                            ...
                                            <div class="form-group col-md-4 mb-4">
                                                ...
                                                <f:input type="text" path="nombreCorto" class="form-control"/>
                                            </div> 
                                        </div> 
                                        <div class="row">
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                <c:forEach var="maestraBean" items="${lstMaestraBean}">
                                                    <tr>
                                                        <td>${maestraBean.codigoTabla}</td>
