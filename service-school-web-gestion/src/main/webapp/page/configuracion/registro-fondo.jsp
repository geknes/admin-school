            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Registro Fondo</a>
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title"> Registro Fondo</h4>
                              ...
                              <div class="card-body collapse in">
                                  <div class="card-block card-dashboard"> 
                                    ...
                                    <div class="col-md-12"> 
                                     <f:form id="frmRegistroFondo" class="form-horizontal" role="form"   enctype="multipart/form-data" method="post" action="grabar" novalidate="true">
                                  <div class="form-body"> 
                                  ...
                                  <div class="col-xs-5">
                                      ...
                                      <f:input type="file" class="filestyle" path="file" id=""  /> 
                                           <img class="media-object "   src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombre}" alt="Generic placeholder image" style="width: 90px;height: 64px;" /> 
                                         </c:if> 
                                         </div>
                                  </div>  -->
                                          ...
                                          <div id="list"   style="cursor: pointer;">
                                             <c:choose> 
                                               <c:when test="${not empty fondoBean.imagenNombre}">
                                                <label for=""><img onclick="obtener_imagen()" src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombre}" alt="${fondoBean.imagenNombre}"  class="img-fluid" data-toggle="modal" data-target="#xlarge" style="cursor: pointer;"></label>  
                                              </c:when> 
                                              <c:otherwise>
                                         ...
                                         <%--  <div class="form-group col-md-3">
                                           ...
                                           <div class="form-group col-md-3 ">
                                                  ...
                                                  <f:input type="text" class="form-control"   path="nombre" data-validation-required-message="Este campo es requerido" required="required"/>
                                                  </div>
                                           </div>
                                           ...
                                           <div class="form-group col-md-3 ">
                                            ...
                                            <div class="form-group col-md-3 ">
                                                  ...
                                                  <div class="controls">
                                                  <f:input type="text" class="form-control" path="monedas" data-validation-required-message="Este campo es requerido" pattern="[0-9]{1,}"  maxlength="10" required="required"/>
                                                 </div> 
                                             </div>
                                             <div class="form-group col-md-2">
                                  ...
                                  <div class="controls">
                                   ...
                                   <f:input style="display:none" type="file"  path="file"    onchange="handleFileSelect(event);" name="files[]" id="file4"  /> 
                                     </c:if></div>
