            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Listado Slider </a>
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado Slider  </h4>
                                    ...
                                    <f:form method="post" action="buscar">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre Slider</label>
                                         ...
                                         <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-hover table-bordered zero-configuration">
                                                ...
                                                <c:forEach var="sliderBean" items="${lstSliderBean}">
                                                    <tr>
													                             	<td>${sliderBean.codigo}</td>
