            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#"> Listado Usuario</a>
                  </li>
                </ol>
              </div>
            </div>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-md-3 mb-2">
                                                ...
                                                <f:input type="text" id="projectinput1" class="form-control" name="fname" path="nombreUsuario"/>
                                            </div>
                                            <!-- <div class="form-group col-md-3 mb-2">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                              ...
                                              <f:select id="perfilUsuario" name="interested" class="form-control" path="codigoPerfil" >
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                ...
                                                <button type="button" class="btn btn-secondary mr-1" onclick="enviar_ajax('${pageContext.request.contextPath}/usuarioController/listado','GET')">
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                	<c:forEach var="usuarioBean" items="${lstUsuarioBean}">
	                                                    <tr>
	                                                        <td>${usuarioBean.codigoUsuario}</td>
