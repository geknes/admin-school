            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Listado Inscripci&oacute;n</a>
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title"> Listado Inscripci&oacute;n</h4>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                          ...
                                          <div class="form-group col-md-6 mb-2">
                                                ...
                                                <f:select id="lblInstitu" path="institucion.codigo" class="form-control">
