                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado Matr&iacute;cula</h4>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                        	<div class="form-group col-md-3 mb-2">
                                              <label for="lblInstitu">Instituciones</label>

                                              	<f:select id="lblInstitu" path="insti.codigo" onchange="buscarLenguaxInstituciontipo2();" name="lblInstitu" class="form-control">
															<f:option value="0" label="Seleccionar" />
															<f:options items="${lstInstitucionBean}" itemValue="codigo" itemLabel="nombreInstitucion" />
												</f:select>
                                            </div>
                                            <div class="form-group col-md-3 mb-2">
                                              <label for="situacionUsuario">Idioma</label>

                                              <f:select id="lblLengua" path="lengua.codigo"  name="lblLengua" onchange="cargarNivelesInscMatri()" class="form-control">
															<f:option value="0" label="Seleccionar" />
                                                ...
                                                <tbody>
                                                  <c:forEach var="matriculaBean" items="${lstMatriculaBean}" varStatus="theCount">
                                                    <tr>
                                                        ...
                                                        <td>
                                                         <a title="Modificar"  data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm" href="modificar?codigo=${matriculaBean.codigo}"><i class="icon-pencil"></i></a>
                                                         ...
                                                         <button type="button" class="btn btn-outline-danger btn-sm"  data-toggle="tooltip" data-placement="top" title="Eliminar" data-original-title="Eliminar"  onclick="confirmar_accion('${matriculaBean.codigo}');" ><i class="icon-trash"></i>
                                                        </td>
                                                    </tr>
