            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Listado de Estudiante</a>
                  </li>
                </ol>
              </div>
            </div>
                        ...
                        <f:form id="frmRegistroAlumno" class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/alumnoController/buscar">
	                      <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de Estudiante </h4>
                                      ...
                                      <div class="form-body">
										...
										--%>
                                            <div class="form-group col-md-4 mb-2">
                                                <label for="nombrePersona">Nombre Estudiante</label>
                                                <div class="controls">
                                                 	<f:input type="text" id="nombrePersona" class="form-control" name="nombrePersona" path="personaBean.nombrePersona" pattern="[a-zA-Z ñÑáéíóúÁÉÍÓÚ]{0,}" />
                                            	 </div>
                                            </div>

                                             <div class="form-group col-md-2 mb-2">
                                                <label for="numeroDocumento">N&uacute;mero Documento</label>
                                                <div class="controls">
                                                <f:input type="text" id="numeroDocumento" class="form-control" name="numeroDocumento" path="personaBean.numeroDocumento" pattern="[0-9]{0,8}"  maxlength="8"/>
                                            	</div>
                                            </div>

                                            <div class="form-group col-md-4 mb-2">
                                            <div class="controls">
                                                <label for="nombreInstitucion">Instituci&oacute;n</label>
                                                <f:input type="text" id="nombreInstitucion" class="form-control" name="nombreInstitucion" path="institucionBean.nombreInstitucion" pattern="[a-zA-Z ñÑáéíóúÁÉÍÓÚ]{0,}"/>
                                            </div>
                                             </div>
                                            ...
                                            <div class="form-group col-md-2 mb-2">
                                              <label for="situacionUsuario">Situaci&oacute;n</label>
                                               <f:select id="tm1Situacion" name="tm1Situacion" path="tm1Situacion.codigoRegistro" class="form-control">
